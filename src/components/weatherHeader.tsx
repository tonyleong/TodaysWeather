  ...
  return (
    <Stack className="w-full" rowGap={1}>
      ...
      <Stack direction='row' alignItems='baseline' >
        ...
        <Typography sx={{ marginLeft: 'auto', color: theme => ThemeConfig.weatherHeder[theme.palette.mode].secondary }} >Clouds</Typography>
      </Stack>
      <Stack direction='row'>
        <Typography sx={{ color: theme => ThemeConfig.weatherHeder[theme.palette.mode].primary }}>H:29° L:26°</Typography>
        <Typography sx={{ marginLeft: 'auto', color: theme => ThemeConfig.weatherHeder[theme.palette.mode].secondary }} >Humidity: 58%</Typography>
      </Stack>
      <Stack direction='row'>
